...
class ConstraintTest extends TestCase {
  ...
  public function providerIsCompatible() {
    ...
    foreach (['', '=', '=='] as $equal_operator) {
      ...
      // Alpha version.
      $alpha = ["{$equal_operator}8.x-1.1-alpha12", '8.x'];
      ...
      // Beta version.
      $beta = ["{$equal_operator}8.x-1.1-beta8", '8.x'];
      ...
      // RC version.
      $rc = ["{$equal_operator}8.x-1.1-rc11", '8.x'];
      ...
      $greater_and_equal_major = ["{$equal_operator} 8.x-2.x, >= 2.4-alpha2", '8.x'];
      ...
      $greater_and_equal_exact = ["{$equal_operator} 8.x-2.0, >= 2.4-alpha2", '8.x'];
      ...
      $tests["({$equal_operator}8.x2.x,{$equal_operator}2.4-beta3)-2.4-beta3"] = [["{$equal_operator} 8.x2.x, {$equal_operator} 2.4-beta3", '8.x',], '2.4-beta3', FALSE];

      // Test with a missing dash.
      $tests["({$equal_operator} 8.x2)-8.x"] = [["{$equal_operator} 8.x2", '8.x'], '8.x', TRUE];

      // Test multiple equals which will always be false.
      $equals_x3 = ["{$equal_operator} 8.x-2.1, {$equal_operator} 8.x-2.3, 8.x.2.5", '8.x'];

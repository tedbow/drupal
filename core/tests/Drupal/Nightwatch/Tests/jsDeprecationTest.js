module.exports = {
  '@tags': ['core'],
   before(browser) {
    browser.drupalInstall().drupalLoginAsAdmin(() => {
      ...
      .waitForElementVisible('input[name="modules[js_deprecation_test][enable]"]', 1000)
  ...
  'Test JavaScript deprecations': browser => {
    ...
    .assert.consoleMessageExists('[Deprecation] Here be kittens!')
    .assert.consoleMessageExists('[Deprecation] Here be llamas!');
  },
};

...
class LayoutBuilderTest extends BrowserTestBase {
  ...
  public function testLayoutBuilderUi() {
    ...
    $this->drupalPostForm(NULL, ['layout[enable_defaults]' => TRUE], 'Save');
  ...
  public function testPluginDependencies() {
    ...
    $this->drupalPostForm('admin/structure/types/manage/bundle_with_section_field/display', ['layout[enable_defaults]' => TRUE], 'Save');
    $assert_session->linkExists('Manage layout');
    $this->clickLink('Manage layout');
  ...
  public function testLayoutBuilderUiFullViewMode() {
    ...
    $this->drupalPostForm("$field_ui_prefix/display/default", ['layout[enable_defaults]' => TRUE], 'Save');
    $this->drupalPostForm("$field_ui_prefix/display/default", ['layout[allow_custom]' => TRUE], 'Save');
  ...
  public function testLayoutBuilderChooseBlocksAlter() {
    ...
    // From the manage display page, go to manage the layout.
    $this->drupalPostForm('admin/structure/types/manage/bundle_with_section_field/display/default', ['layout[enable_defaults]' => TRUE], 'Save');
    $assert_session->linkExists('Manage layout');
    $this->clickLink('Manage layout');

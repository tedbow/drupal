...
class MakeLayoutUntranslatableUpdatePathTest extends UpdatePathTestBase {
   ...
   * @see layout_builder_post_update_make_layout_untranslatable()
   *
   * @dataProvider providerDisableTranslationOnLayouts
   */
  public function testDisableTranslationOnLayouts($test_cases, $expected_bundle_updates) {
    $this->assertTrue(is_array($test_cases));
    $this->layout_builder_test_cases = $test_cases;
    $this->runUpdates();
  ...
  public function providerDisableTranslationOnLayouts() {
    return [
      'article:has_translation:no_layouts page:no_translation:has_layout' => [
        'test_cases' => [
          'article' => [

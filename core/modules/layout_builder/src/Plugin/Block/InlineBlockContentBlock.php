 ...
 * )
 */
class InlineBlockContentBlock extends BlockBase implements ContextAwarePluginInterface, ContainerFactoryPluginInterface {
  ...
  public function build() {
    $block = $this->getEntity();
    $block->setAccessDependency($this->getContextValue('entity'));

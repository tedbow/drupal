...
class LayoutBuilderEntityViewDisplayForm extends EntityViewDisplayEditForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($this->entity->getMode() === 'default') {
      ...
      $form['layout']['allow_custom'] = [
        ...
        '#states' => [
          'disabled' => [
            ':input[name="layout[is_enabled]"]' => ['checked' => FALSE],
          ],
          'invisible' => [
            ':input[name="layout[is_enabled]"]' => ['checked' => FALSE],
          ],
      ...
      if ($this->hasOverrides($this->entity)) {
        $form['layout']['is_enabled']['#disabled'] = TRUE;
        $form['layout']['is_enabled']['#description'] = $this->t('You must revert all customized layouts of this display before you can disable this option.');
  ...
  protected function copyFormValuesToEntity(EntityInterface $entity, array $form, FormStateInterface $form_state) {
    ...
    $set_enabled = (bool) $form_state->getValue(['layout', 'is_enabled'], FALSE);

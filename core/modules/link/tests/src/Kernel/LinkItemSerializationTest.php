...
class LinkItemSerializationTest extends FieldKernelTestBase {
  ...
  public function testLinkDeserialization() {
    ...
    $this->setExpectedException(\LogicException::class, 'The generic FieldItemNormalizer cannot denormalize string values for "options" properties of "link" fields (field item class: Drupal\link\Plugin\Field\FieldType\LinkItem).');

...
class FieldItemNormalizer extends ComplexDataNormalizer implements DenormalizerInterface {
  ...
  public function normalize($object, $format = NULL, array $context = []) {
    ...
    foreach ($field_item->getProperties(TRUE) as $name => $field) {
      $property_value = $this->serializer->normalize($field, $format, $context);
      if (!empty($context['cacheability']) && $property_value instanceof CacheableDependencyInterface) {
    ...
    return $attributes;
    //return parent::normalize($object, $format, $context); // TODO: Change the autogenerated stub
  }

...
class UpdateCoreTest extends UpdateTestBase {
  ...
  public function securityCoverageMessageProvider() {
    ...
    return [
      ...
      // Ensure that the version before a LTS indicates that it will be
      // supported until the next major is released.
      '8.8, supported' => [
        'site_patch_version' => '8.0',
        'requirements_section_message' => 'Checked',
        'fixture' => 'sec.8.0',
        'coverage_messages' => [
          'The installed minor version of Drupal, 8.8, will receive security updates until the release of 9.0.0.',
          $release_coverage_message,
        ],
        'not_contains_messages' => [
          'or higher soon to continue receiving security updates.',
      ...
      // Ensure that an LTS version indicates when it's support ends.
      '8.9, lts' => [

...
class FormTest extends FieldTestBase {
  ...
  public function testFieldFormSingle() {
    ...
    // Check that hook_field_widget_form_alter() does not believe this is the
    // default value form.
    $this->assertNoText('From hook_field_widget_multiple_form_alter(): Default form is true.', 'Not default value form in hook_field_widget_form_alter().');
  ...
  /**
   * Tests hook_field_widget_multiple_form_alter().
   */
  public function testFieldFormMultipleWidgetAlter() {
    $this->widgetAlterTest('hook_field_widget_multiple_form_alter');
  }

  /**
   * Tests hook_field_widget_multiple_WIDGET_TYPE_form_alter().
   */
  public function testFieldFormMultipleWidgetTypeAlter() {
    $this->widgetAlterTest('hook_field_widget_multiple_WIDGET_TYPE_form_alter');
  }

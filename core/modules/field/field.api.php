 ...
 * cannot alter the top level (parent element) for multivalue fields. In most
 * cases, you should use hook_field_widget_multiple_form_alter() instead and
 ...
 * This hook can only modify individual elements within a field widget and
 * cannot alter the top level (parent element) for multivalue fields. In most
 * cases, you should use hook_field_widget_multiple_WIDGET_TYPE_form_alter()
 ...
 *   \Drupal\Core\Field\Widget::formMultipleElements().
 ...
 *   The current state of the form.
 * @param array $context
 *   An associative array. See hook_field_widget_multiple_form_alter() for
...
function hook_field_widget_multiple_WIDGET_TYPE_form_alter(array &$elements, \Drupal\Core\Form\FormStateInterface $form_state, array $context) {
  // Code here will only act on widgets of type WIDGET_TYPE. For example,
  // hook_field_widget_multiple_mymodule_autocomplete_form_alter() will only
